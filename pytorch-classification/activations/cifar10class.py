...
# Modified get_class_i to return the absolute index into the data set for a particular
# image, may not be compatible with other usages outside of collecting activations
def get_class_i(x, y, i):
    ...
    x_i = [(idx, x[idx]) for idx in pos_i]
    return x_i
...
"""
    Modified DatasetMaker class to get data from the i'th class in particular
    May not be compatible with other usages outside of colllecting activations
"""
class i_DatasetMaker(Dataset):
    ...
    def __getitem__(self, i):
        ...
        return img, self.class_index, abs_indx
