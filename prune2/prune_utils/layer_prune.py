...
def prune_output_linear_layer_(linear_layer, class_indices):
...
def prune_batchnorm2d(bn, pruned_indices):
    ...
    new_bn.running_mean.data = prune_tensor(bn.running_mean.data, 0, pruned_indices)
    new_bn.running_var.data = prune_tensor(bn.running_var.data, 0, pruned_indices)
    return new_bn
...
def prune_batchnorm2d_(bn, pruned_indices):
    ...
    bn.running_mean.data = prune_tensor(bn.running_mean.data, 0, pruned_indices)
